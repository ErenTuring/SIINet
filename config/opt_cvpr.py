...
# -*- coding: utf-8 -*-
'''
Default Config about cvpr_road dataset.
'''
...
class DefaultConfig(object):
    ...
    root = '/home/tao/Data/cvpr_road'  # ISPRS,cvpr_road,Road_Car,Road,KITTIT
    dataset_dir = root
    ckpt = root + '/Model/cp'  # + '/Rate'
    ...
    alpha = 0.7  # BCE_loss: IoU_loss = alpha: 1-alpha

    # Data related arguments
    num_classes = 2
    num_workers = 2  # number of data loading workers
    siis_size = [32, 32]  # 56-448
    ...
    mean = [0.28812134, 0.38283396, 0.40970668]  # BGR, 此处的均值应该是0-1
