...
# -*- coding: utf-8 -*-
'''
Default Config about roadtracer dataset.
'''
...
class DefaultConfig(object):
    ...
    root = '/home/tao/Data/Seg/roadtracer_org'  # ISPRS,cvpr_road,Road_Car,Road,KITTIT
    dataset_dir = root
    ckpt = root + '/Model/cp'
    ...
    max_epoch = 50  # 16-[256,256] dataset only need 8~9 epoch
    ckpt_freq = 3
    lr = 1e-5  # initial learning rate
    lr_decay = 0.98  # pre epoch
    weight_decay = 1e-5  # L2 loss
    loss = ['MSELoss', 'BCEWithLogitsLoss', ''][0]
    loss_weight = [0.1, 0.9]  # init loss weight: [bg, road]
